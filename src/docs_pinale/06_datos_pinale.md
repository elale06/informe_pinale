...
* **Números de Cuenta Bancaria / Códigos SWIFT:** Dato Personal de carácter financiero.
* **Montos de las transacciones:** Dato Personal.
...
2. **Derecho de Rectificación (Art. 13):** Si los atacantes hubiesen alterado los saldos de los clientes o creado registros de transacciones falsas a nombre de personas reales, estas tendrían el derecho a exigir que el banco modifique y restablezca la información verídica de sus cuentas.
3. **Derecho de Cancelación (Art. 13):** Frente a la creación de registros fraudulentos, bases de datos temporales maliciosas o beneficiarios falsos inyectados por los atacantes en las bases del banco, existe la obligación de eliminar (cancelar) dichos datos que carecen de fundamento legal y son fruto de un ilícito.